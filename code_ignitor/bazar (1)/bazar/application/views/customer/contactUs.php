...
<div class="container-fluid bg-dark " id="head">
  ...
  <!-- Header -->
    ...
    <center><h1>Wlcome to Contact page</h1></center>

                                  <!-- main -->
<div class="container " style="height:350px;" >
      <div class="row justify-content-arround">
           <div class="col-sm-4" id="contactDiv">
             <div class="row">
             <div class="col-sm-6">
          ...
          <div class="form-floating mt-2">
           ...
           <div class="form-group " style="margin-left:120px; width: 200px;">
             <button class="btn  btn-block btn-primary mt-3">SUBMIT NOW</button>
          </div>
