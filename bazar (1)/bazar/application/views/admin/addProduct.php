...
<div class="container-fluid " >
      <div class="row justify-content-between" >
           ...
           <div class="col-sm-3" id="dashLinkList">
                ...
                <ul class="list-group list-group-flush mt-5" id="dashLink">
 ...
 <div class="col-sm-9 " >
      <div class="row justify-content-center">
       ...
       <hr>
            ...
            <form action="<?php echo base_url().'index.php/ProductCtrl/Addproduct'?>" method="post" name="registerForm" id="registerForm" enctypte="multipart/form-data">
           <div class="card-body" style="background: #ECF0F1;">         
          <div class="form-group">
              <label for="prod_name">Product Name</label>
              <input type="text" name="prod_name" id="prod_name" placeholder="Enter a Product Name" value="" class="form-control">
              <p><?php echo form_error('prod_name');?></p>
          </div>

          <!-- asked tommarow samir bhai -->
          <div class="form-group">
              <label for="subcat_id">Sub Category ID</label>
              <input type="text" name="subcat_id" id="subcat_id" placeholder="Enter a sub Category ID" value="" class="form-control">
              <p><?php echo form_error('subcat_id');?></p>
          </div>
          <div class="form-group">
              <label for="prod_quantity">Product Quantity</label>
              <input type="text" name="prod_quantity" id="prod_quantity" placeholder="Enter a product quantity" value="" class="form-control">
              <p><?php echo form_error('prod_quantity');?></p>
          </div>
          <div class="form-group">
              <label for="">product Image </label>
              <input type="file" name="prod_image" id="prod_image"  value="" class="form-control">
              <p><?php echo form_error('product_image');?></p>
          </div>
          <div class="form-group">
              <label for="prod_unitPrice">product Unit price </label>
              <input type="text" name="prod_unitPrice" id="product Unit price" placeholder="Enter a product_price" value="" class="form-control">
